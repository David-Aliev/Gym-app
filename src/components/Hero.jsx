...
export default function Hero() {
  return (
    ...
    <div className='flex flex-col gap-4'>
      ...
      <p className='text-sm md:text-base font-light'>this is the text that i maybeeee would change in someday,but today i dont have enough strange or power to did it,so its kinda random words with no contex in it heh</p>
