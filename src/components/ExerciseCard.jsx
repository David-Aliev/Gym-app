...
export default function ExerciseCard(props) {
   const [setsCompleted,setSetsComplited] = useState(0)

   const {exercise,i} = props

   function setIncrementHandle() {
      setSetsComplited((setsCompleted + 1) % 6)
   }
  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <button onClick={setIncrementHandle} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:border-blue-600 w-full '>
